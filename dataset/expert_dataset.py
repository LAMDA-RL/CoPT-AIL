...
class ExpertDataset(Dataset):
    ...
    def __init__(self,
        ...
        Args:
            ...
            deterministic:            If true, sample deterministic expert trajectories.
        """
...
def load_trajectories(expert_location: str,
    ...
    if os.path.isfile(expert_location):
        ...
        trajs = {}
        trajs["states"] = data[1][:100, :499, :]
        trajs['actions'] = data[2][:100, :499, :]
        trajs["next_states"] = data[1][:100, 1:, :]
        trajs['rewards'] = data[3][:100, :499]
        trajs['dones'] = np.zeros_like(trajs['rewards'])
        trajs['lengths'] = np.ones((100, 1), dtype=np.int32) * 499
